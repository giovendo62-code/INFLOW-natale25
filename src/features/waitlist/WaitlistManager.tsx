...
import { Search, Filter, QrCode, CheckCircle, Clock, UserPlus, ChevronDown, ArrowDownWideNarrow, ArrowUpNarrowWide, PenTool, Check, Link, ChevronDownCircle, Edit3, Save, X, StickyNote } from 'lucide-react';

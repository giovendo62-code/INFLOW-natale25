...
-- 2. Creazione Bucket Storage 'waitlist' per performance (Upload Immagini)
INSERT INTO storage.buckets (id, name, public) 
VALUES ('waitlist', 'waitlist', true) 
ON CONFLICT (id) DO NOTHING;

-- Policy: Permetti upload pubblico (anonimi e utenti) nel bucket 'waitlist'
...
-- Policy: Permetti visualizzazione pubblica del bucket 'waitlist'
